...
const HomePage = () => {
  return (
    <div className=' min-h-screen py-20 text-white flex flex-col-reverse lg:flex-row md:gap-16 md:items-center justify-center font-primary px-8'>
      ...
      <h2 className='font-bold relative text-2xl md:text-4xl lg:text-5xl z-10 py-8'><p className='text-amber-500 inline pr-2'>Welcome</p> 
      to AiChefMaster <p>Dashboard </p> </h2>
      
      <p className='description text-lg md:text-xl font-medium text-zinc-300  pb-8 relative'>Bring your signature dishes to life on our platform. Every recipe, every ingredient, and every cooking technique you provide adds a unique flavor to our growing culinary library.</p>
