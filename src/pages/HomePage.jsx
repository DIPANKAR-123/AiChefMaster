...
const HomePage = () => {
  return (
    <div className=' min-h-screen py-20 text-black flex flex-col-reverse lg:flex-row md:gap-16 md:items-center justify-center font-primary px-8'>
      ...
      <Link to='/signup'>
      <button className="bg-orange-600 hover:bg-orange-700 group  relative px-8 py-3 overflow-hidden font-medium rounded-xl border  text-xl md:text-2xl shadow-2xl  mr-8 my-8">
