...
const DishResultCard = ({dish}) => {
  ...
  return (
    <div className="w-[300px] flex flex-col gap-3 rounded-xl  px-8 py-6 text-lg md:text-xl bg-[linear-gradient(45deg,transparent_25%,rgba(68,68,68,.2)_50%,transparent_75%,transparent_100%)] bg-zinc-950 relative   border-zinc-700 bg-[length:250%_250%,100%_100%] bg-[position:-100%_0,0_0] bg-no-repeat shadow-2xl transition-[background-position_0s_ease] hover:bg-[position:200%_0,0_0] hover:duration-[1200ms] text-white p-6 border  shadow-black">
